...
Bbox:     10.0 × 10.0 × 33.0 mm

HOW TO USE:
  1. In Fusion 360, open the STEP file: outputs\\cad\\step\\barrel_arbor.step
...
def run(context):
    ...
    try:
        ...
        adaptiveInput.parameters.itemByName("optimalLoad").expression = "0.07"
        adaptiveInput.parameters.itemByName("maximumStepdown").expression = "0.1"
        ...
        outputFolder = r"C:\\Users\\jonko\\Downloads\\aria-auto-belay\\outputs\\cam\\barrel_arbor\\gcode"
        postInput = adsk.cam.PostOutputUnitOptions.DocumentUnitsOutput
        if postConfig:
            cam.postProcess(setup, postConfig, outputFolder, postInput, "barrel_arbor")
            ui.messageBox(f"CAM complete! Gcode saved to:\nC:\\Users\\jonko\\Downloads\\aria-auto-belay\\outputs\\cam\\barrel_arbor\\gcode")
        else:
